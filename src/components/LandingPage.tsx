...
const HERO_SUBLINE =
  'Have a story idea? Enter a short summary or synopsis of your story idea, and let our ARCS application guide you through fleshing out your idea for a script or a comic book. Then use our image studios to generate images for illustrating your idea. Then use your images create a comic book or setup an outline for video generation!';
