 ...
 */
export type GenerationContextType = 'character' | 'asset' | 'supporting_reference';
...
export const SYSTEM_PROMPTS: Record<GenerationContextType, string> = {
  ...
  supporting_reference:
    "You are a visual development assistant helping an illustrator build a reusable reference library. Generate one-off NPCs, cameo characters, exploratory environments, and mood-board images. Prioritize clarity, likeness stability (when references are provided), and clean compositions that can be reused later. Do not over-stylize unless the user asks; avoid unrelated background clutter.",
};
